...
using IntentBot.Infrastructure.Services;
using IntentBot.Application.Bots;
using IntentBot.Application.Bots.Adapters;
using IntentBot.Application.Bots.Dialogs;
using Microsoft.EntityFrameworkCore;

namespace IntentBot.Application;
...
public class Startup {
    ...
    public void ConfigureServices(IServiceCollection services) {
        ...
        services.AddTransient<IBot, IntentDetectionBot>();
    }
